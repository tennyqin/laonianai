...
public class StructuredDataService {
    ...
    public String buildHome(String lang, String siteName, String title, String description) {
        ...
        webpage.put("isPartOf", Collections.singletonMap("@id", BASE_URL + "/#website"));
        items.add(webpage);
    ...
    public String buildCountry(CountryDetail detail, String lang, String canonicalUrl) {
    ...
    public String buildCountry(CountryDetail detail,
        ...
        String canonicalRoute = canonicalCountryRoute(detail.getCode());
        ...
        elements.add(breadcrumbItem(1, "zh".equals(lang) ? "首页" : "Home", BASE_URL + "/?lang=" + lang));
        elements.add(breadcrumbItem(2, name, BASE_URL + "/country/" + canonicalRoute + "?lang=" + lang));
    ...
    public String buildCountryHome(CountryDetail detail,
        ...
        for (String type : types) {
            ...
            li.put("position", pos++);
            li.put("name", label);
            li.put("url", BASE_URL + "/country/" + canonicalRoute + "/" + type + "?lang=" + lang);
            listItems.add(li);
        }
    ...
    public String buildArticle(Map<String, Object> article, String lang, String canonicalUrl) {
        String title = "zh".equals(lang) ? stringValue(article.get("titleZh")) : stringValue(article.get("titleEn"));
        String description = "zh".equals(lang) ? stringValue(article.get("summaryZh")) : stringValue(article.get("summaryEn"));
    ...
    public String buildVisaGuide(String lang, String title, String description, String canonicalUrl) {
        Map<String, Object> data = new LinkedHashMap<>();
        data.put("@context", "https://schema.org");
    ...
    private String canonicalCountryRoute(String code) {
        return countryCodeResolver.routeCode(countryCodeResolver.policyKey(code));
    }
    ...
    private String toJson(Object object) {
        try {
            ...
            throw new IllegalStateException("Failed to generate structured data", e);
        }
    }
